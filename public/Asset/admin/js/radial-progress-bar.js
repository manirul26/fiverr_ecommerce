...
function radialProgress($obj, options) {
  ...
  }).addClass("d_progress_first_circle");
  ...
  this.$radialFirstHalf = $("<div>").appendTo(this.$radialFirstHalfMask).css({
    ...
    "border-style": "solid",
    "border-color": this.options['color'] + " " + this.options['color'] + ` ${this.options['color2']} ${this.options['color2']}`,
    "width": "200%",
    "height": "100%",
    "border-radius": "50%",
    "left": "-100%",
  ...
  if (this.options['text-color']) {
    ...
    }).addClass("progress_text").attr("data-progressText", this.options['progressText']);
  }
